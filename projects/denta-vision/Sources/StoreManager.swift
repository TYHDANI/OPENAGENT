...
final class StoreManager {
    ...
    static let b2bLiteMonthly = "com.dentimatch.subscription.b2b.lite.monthly"    // $299/mo
    static let b2bProMonthly = "com.dentimatch.subscription.b2b.pro.monthly"      // $499/mo

    /// B2C Subscription (for future expansion)
    static let b2cPremiumMonthly = "com.dentimatch.subscription.b2c.premium.monthly"  // $9.99/mo

    static let allProductIDs: Set<String> = [
        b2bLiteMonthly, b2bProMonthly, b2cPremiumMonthly
    ]
    ...
    /// Controls the presentation of the paywall sheet
