...
final class StoreManager {
    ...
    /// Product identifiers for GEM OS subscriptions
    static let basicMonthlyID = "com.gemos.subscription.basic.monthly"  // $99/month
    static let professionalMonthlyID = "com.gemos.subscription.professional.monthly"  // $299/month

    static let allProductIDs: Set<String> = [
        basicMonthlyID, professionalMonthlyID
    ]
