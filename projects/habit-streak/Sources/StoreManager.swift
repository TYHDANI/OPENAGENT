...
final class StoreManager {
    ...
    /// Product identifiers — the monetization agent replaces these placeholders.
    static let monthlyID  = "com.streamflow.habits.subscription.monthly"
    static let yearlyID   = "com.streamflow.habits.subscription.yearly"
    static let lifetimeID = "com.streamflow.habits.lifetime"
