...
final class StoreManager {
    ...
    /// Product identifiers for MaterialSource subscriptions
    static let monthlyID  = "com.materialsource.app.subscription.monthly"
    static let yearlyID   = "com.materialsource.app.subscription.yearly"
    static let lifetimeID = "com.materialsource.app.subscription.lifetime"
