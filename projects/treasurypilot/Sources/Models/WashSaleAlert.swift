...
struct WashSaleAlert: Identifiable, Codable, Hashable {
    let id: UUID
    ...
    init(
        ...
        self.buyTransactionID = buyTransactionID
        self.saleEntityID = saleEntityID
        self.buyEntityID = buyEntityID
        self.asset = asset
        self.saleDate = saleDate
        self.buyDate = buyDate
        self.disallowedLoss = disallowedLoss
        self.daysApart = daysApart
